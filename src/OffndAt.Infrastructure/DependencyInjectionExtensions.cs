...
public static class DependencyInjectionExtensions
{
    ...
    public static IServiceCollection AddCorsPolicies(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        _ = services.AddCors(options => options.AddDefaultPolicy(builder => builder
            .SetIsOriginAllowed(origin =>
                corsSettings.AllowedOrigins.Any(allowedOrigin => allowedOrigin.Equals(
                    new Uri(origin).Host,
        ...
        services.AddResiliencePipeline<string, Result<Phrase>>(
            ...
            builder => builder.AddRetry(
                new RetryStrategyOptions<Result<Phrase>>
                {
                    ...
                    MaxRetryAttempts = 10,
                    ShouldHandle =
                        new PredicateBuilder<Result<Phrase>>().HandleResult(result =>
